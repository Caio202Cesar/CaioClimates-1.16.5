...
public enum ClimateType {
    ...
    TROPICAL_DESERT(new float[]{1.2F, 2.0F, 1.2F, 1.2F}, new boolean[] {false, false, false, false}),
    SUBTROPICAL_DESERT(new float[]{0.8F, 2.0F, 1.2F, 0.4F}, new boolean[] {false, false, false, false}),
