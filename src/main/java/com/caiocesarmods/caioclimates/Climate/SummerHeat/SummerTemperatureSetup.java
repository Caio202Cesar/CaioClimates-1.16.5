...
public class SummerTemperatureSetup {
    public static void register() {
        ...
        SummerTemperatureRegistry.register(new ResourceLocation("minecraft", "modified_gravelly_mountains"), 0.2F);
        ...
        SummerTemperatureRegistry.register(new ResourceLocation("caiocesarbiomes", "jungle_highland"), 0.95F);
        SummerTemperatureRegistry.register(new ResourceLocation("caiocesarbiomes", "montane_cloud_jungle"), 0.95F);
        ...
        SummerTemperatureRegistry.register(new ResourceLocation("caiocesarbiomes", "ficus_jungle"), 0.95F);
